...
describe('places routes', () => {
  ...
  it('can create a place via POST', () => {
    return request(app)
      .post('/api/v1/places')
      .send({ placeName: 'Momos', address: '1111122 PDX', startTime: '14:00', endTime: '16:00', monday: true, tuesday: true, wednesday: true, thursday: true, friday: true, saturday: true, sunday: true, sports: true, queer: true, fancy: true, ac: true, patio: true, groups: true, dive: true, dog: true, games: true, dates: true, wheelchair: true, noisy: true, vegan: true, vegetarian: true, gluten: true, parking: true, reservations: true })
      .then(res => {
